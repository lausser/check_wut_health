...
sub init {
  ...
  $self->get_snmp_tables("EMD-MIB", [
      ["sensors", "externalSensorConfigurationTable", "Classes::Raritan::EMD::Component::SensorSubsystem::Sensor"],
      #["devices", "peripheralDevicePackageTable", "Classes::Raritan::EMD::Component::SensorSubsystem::Device"],
      #["servers", "serverReachabilityTable", "Classes::Raritan::EMD::Component::SensorSubsystem::Server"],
      #["logindexes", "logIndexTable", "Classes::Raritan::EMD::Component::SensorSubsystem::LogIndex"],
      #["logtimestamps", "logTimeStampTable", "Classes::Raritan::EMD::Component::SensorSubsystem::LogTimeStamp"],
      #["sensorlogs", "externalSensorLogTable", "Classes::Raritan::EMD::Component::SensorSubsystem::ExternalSensorlog"],
      ["measurements", "externalSensorMeasurementsTable", "Classes::Raritan::EMD::Component::SensorSubsystem::ExternalSensorMeasurement"],
      #["actuators", "actuatorControlTable", "Classes::Raritan::EMD::Component::SensorSubsystem::ActuatorControl"],
  ]);
...
sub finish {
  ...
  if ($self->{externalSensorType} eq "onOff") {
    bless $self, "Classes::Raritan::EMD::Component::SensorSubsystem::Sensor::onOff";
  }
}
...
package Classes::Raritan::EMD::Component::SensorSubsystem::Sensor::onOff;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;
...
package Classes::Raritan::EMD::Component::SensorSubsystem::Device;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;

package Classes::Raritan::EMD::Component::SensorSubsystem::Server;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;

package Classes::Raritan::EMD::Component::SensorSubsystem::LogIndexTable;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;

package Classes::Raritan::EMD::Component::SensorSubsystem::LogTimeStamp;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;
...
package Classes::Raritan::EMD::Component::SensorSubsystem::ExternalSensorlog;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;

package Classes::Raritan::EMD::Component::SensorSubsystem::ExternalSensorMeasurement;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;
...
package Classes::Raritan::EMD::Component::SensorSubsystem::ActuatorControl;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;
