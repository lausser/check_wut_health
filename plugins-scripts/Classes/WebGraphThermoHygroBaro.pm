...
#
package Classes::WebGraphThermoHygroBaro;
...
sub init {
  ...
  if ($self->mode =~ /device::sensor::status/) {
    $self->analyze_and_check_sensor_subsystem("Classes::WebGraphThermoHygroBaro::SensorSubsystem");
  } elsif ($self->mode =~ /device::hardware::health/) {
    $self->analyze_and_check_diag_subsystem("Classes::WebGraphThermoHygroBaro::DiagSubsystem");
  } else {
    $self->no_such_mode();
  }
}
...
package Classes::WebGraphThermoHygroBaro::DiagSubsystem;
...
package Classes::WebGraphThermoHygroBaro::SensorSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);
use strict;
...
sub init {
  ...
  $self->get_snmp_tables("WebGraph-Thermo-Hygro-Barometer-US-MIB", [
      ["sensors", "wtWebGraphThermoHygroBaroBinaryTempValueTable", "Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor"],
      ["alarms", "wtWebGraphThermoHygroBaroAlarmTable", "Classes::WebGraphThermoHygroBaro::SensorSubsystem::Alarm"],
      ["alarmsf", "wtWebGraphThermoHygroBaroAlarmIfTable", "Classes::WebGraphThermoHygroBaro::SensorSubsystem::AlarmIf"],
      ["ports", "wtWebGraphThermoHygroBaroPortTable", "Classes::WebGraphThermoHygroBaro::SensorSubsystem::Port"],
  ]);
...
package Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor;
...
sub rebless {
  ...
  if ($self->{wtWebGraphThermoHygroBaroPortName} =~ /^temp/i) {
    bless $self, "Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor::Temperature";
  } elsif ($self->{wtWebGraphThermoHygroBaroPortName} =~ /^hum/i) {
    bless $self, "Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor::Humidity";
  } elsif ($self->{wtWebGraphThermoHygroBaroPortName} =~ /^pres/i) {
    bless $self, "Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor::Pressure";
  }
}
...
package Classes::WebGraphThermoHygroBaro::SensorSubsystem::Alarm;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::WebGraphThermoHygroBaro::SensorSubsystem::AlarmIf;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);


package Classes::WebGraphThermoHygroBaro::SensorSubsystem::Port;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);


package Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor::Temperature;
our @ISA = qw(Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor);
...
package Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor::Humidity;
our @ISA = qw(Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor);
...
package Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor::Pressure;
our @ISA = qw(Classes::WebGraphThermoHygroBaro::SensorSubsystem::Sensor);
...
package Classes::WebGraphThermoHygroBaroUS;
our @ISA = qw(Classes::Device);
use strict;
...
sub init {
  my $self = shift;
  if ($self->mode =~ /device::sensor::status/) {
    $self->analyze_and_check_sensor_subsystem("Classes::WebGraphThermoHygroBaroUS::SensorSubsystem");
  } elsif ($self->mode =~ /device::hardware::health/) {
    $self->analyze_and_check_diag_subsystem("Classes::WebGraphThermoHygroBaroUS::DiagSubsystem");
  } else {
    $self->no_such_mode();
  }
}
...
package Classes::WebGraphThermoHygroBaroUS::DiagSubsystem;
our @ISA = qw(Classes::WebGraphThermoHygroBaro::DiagSubsystem);
use strict;
...
package Classes::WebGraphThermoHygroBaroUS::SensorSubsystem;
our @ISA = qw(Classes::WebGraphThermoHygroBaro::SensorSubsystem);
use strict;
...
sub init {
  ...
  $self->get_snmp_objects("WebGraph-Thermo-Hygro-Barometer-US-MIB",
      qw(wtWebGraphThermoHygroBaroSensors wtWebGraphThermoHygroBaroAlarmCount wtWebGraphThermoHygroBaroPorts));
  $self->get_snmp_tables("WebGraph-Thermo-Hygro-Barometer-US-MIB", [
      ["sensors", "wtWebGraphThermoHygroBaroBinaryTempValueTable", "Classes::WebGraphThermoHygroBaroUS::SensorSubsystem::Sensor"],
      ["alarms", "wtWebGraphThermoHygroBaroAlarmTable", "Classes::WebGraphThermoHygroBaroUS::SensorSubsystem::Alarm"],
      ["alarmsf", "wtWebGraphThermoHygroBaroAlarmIfTable", "Classes::WebGraphThermoHygroBaroUS::SensorSubsystem::AlarmIf"],
      ["ports", "wtWebGraphThermoHygroBaroPortTable", "Classes::WebGraphThermoHygroBaroUS::SensorSubsystem::Port"],
  ]);
  @{$self->{sensors}} = grep { $self->filter_name($_->{flat_indices}) } @{$self->{sensors}};
  $self->finish();
}
