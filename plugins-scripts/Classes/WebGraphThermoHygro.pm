...
# 
package Classes::WebGraphThermoHygro;
...
sub init {
  ...
  if ($self->mode =~ /device::sensor::status/) {
    $self->analyze_and_check_sensor_subsystem("Classes::WebGraphThermoHygro::SensorSubsystem");
  } elsif ($self->mode =~ /device::hardware::health/) {
    $self->analyze_and_check_diag_subsystem("Classes::WebGraphThermoHygro::DiagSubsystem");
  } else {
    $self->no_such_mode();
  }
}
...
package Classes::WebGraphThermoHygro::DiagSubsystem;
...
package Classes::WebGraphThermoHygro::SensorSubsystem;
our @ISA = qw(Monitoring::GLPlugin::SNMP::Item);
use strict;
...
sub init {
  ...
  $self->get_snmp_tables("WEBGRAPH-THERMO-HYGROMETER-MIB", [
      ["sensors", "wtWebGraphThermHygroBinaryTempValueTable", "Classes::WebGraphThermoHygro::SensorSubsystem::Sensor"],
      ["alarms", "wtWebGraphThermHygroAlarmTable", "Classes::WebGraphThermoHygro::SensorSubsystem::Alarm"],
      ["alarmsf", "wtWebGraphThermHygroAlarmIfTable", "Classes::WebGraphThermoHygro::SensorSubsystem::AlarmIf"],
      ["ports", "wtWebGraphThermHygroPortTable", "Classes::WebGraphThermoHygro::SensorSubsystem::Port"],
  ]);
...
package Classes::WebGraphThermoHygro::SensorSubsystem::Sensor;
...
package Classes::WebGraphThermoHygro::SensorSubsystem::Alarm;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::WebGraphThermoHygro::SensorSubsystem::AlarmIf;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);


package Classes::WebGraphThermoHygro::SensorSubsystem::Port;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);


package Classes::WebGraphThermoHygro::SensorSubsystem::Sensor::Temperature;
our @ISA = qw(Classes::WebGraphThermoHygro::SensorSubsystem::Sensor);
...
package Classes::WebGraphThermoHygro::SensorSubsystem::Sensor::Humidity;
our @ISA = qw(Classes::WebGraphThermoHygro::SensorSubsystem::Sensor);
...
package Classes::WebGraphThermoHygro::SensorSubsystem::Sensor::Pressure;
our @ISA = qw(Classes::WebGraphThermoHygro::SensorSubsystem::Sensor);
...
package Classes::WebGraphThermoHygroUS;
our @ISA = qw(Classes::Device);
use strict;
...
sub init {
  my $self = shift;
  if ($self->mode =~ /device::sensor::status/) {
    $self->analyze_and_check_sensor_subsystem("Classes::WebGraphThermoHygroUS::SensorSubsystem");
  } elsif ($self->mode =~ /device::hardware::health/) {
    $self->analyze_and_check_diag_subsystem("Classes::WebGraphThermoHygroUS::DiagSubsystem");
  } else {
    $self->no_such_mode();
  }
}
...
package Classes::WebGraphThermoHygroUS::DiagSubsystem;
our @ISA = qw(Classes::WebGraphThermoHygro::DiagSubsystem);
use strict;
...
package Classes::WebGraphThermoHygroUS::SensorSubsystem;
our @ISA = qw(Classes::WebGraphThermoHygro::SensorSubsystem);
use strict;
