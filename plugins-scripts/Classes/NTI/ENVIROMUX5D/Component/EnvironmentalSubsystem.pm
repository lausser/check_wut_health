package Classes::NTI::ENVIROMUX5D::Components::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables("ENVIROMUX5D", [
      ["powersupplies", "pwrSupplyTable", "Classes::NTI::ENVIROMUX5D::Components::EnvironmentalSubsystem::Powersupply"],
  ]);
}


package Classes::NTI::ENVIROMUX5D::Components::EnvironmentalSubsystem::Powersupply;
